...
namespace Runtime
{
    public class LoggerTest : MonoBehaviour
    {
        ...
        protected void Awake()
        {
            ...
            LoggingUtilities.LogMatrix($"Easy logging for 2D Array:", twoDArray, LogColor.chartreuse);
            LoggingUtilities.LogMatrix($"Easy logging for Jagged Array:", jaggedArray, LogColor.indigo);
            
            LoggingUtilities.LogHexagonalMatrix($"Easy Hex logging for Matrix:", twoDArray, LogColor.tomato);
        }
    }
}
